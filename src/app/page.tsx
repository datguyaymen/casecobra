    ...
    <div className="bg-slate-50">
          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              <h1 className="relative mt-16 w-fit text-balance text-5xl font-bold !leading-tight tracking-tight text-gray-900 md:text-6xl lg:text-7xl">
                Your Image on a{" "}
                <span className="bg-green-600 p-2 text-white">Custom</span>{" "}
                Phone Case
              </h1>
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className="grid-col-1 mx-auto grid max-w-2xl gap-y-16 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="mt-2 flex gap-4">
                ...
                <div className="flex flex-col">
                  <p className="font-semibold">Jonas</p>
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <ul className="mx-auto mt-12 w-fit max-w-prose space-y-2 sm:text-lg">
            <li className="w-fit">
              <Check className="h5 mr-1.5 inline w-5 text-green-600" />
            ...
            <li className="w-fit">
              <Check className="h5 mr-1.5 inline w-5 text-green-600" />5 year
              print warranty
            </li>
