...
import { ArrowRight, Check, ChevronsUpDown, ColumnsIcon } from "lucide-react";
    ...
    <div className="relative mb-20 mt-20 grid grid-cols-1 pb-20 lg:grid-cols-3">
      ...
      <div className="col-span-full flex h-[37.5rem] w-full flex-col bg-white lg:col-span-1">
        <ScrollArea className="relative flex-1 overflow-auto">
          <div
            aria-hidden="true"
            className="pointer-events-none absolute inset-x-1 bottom-0 z-10 h-12 bg-gradient-to-t from-white"
          />
